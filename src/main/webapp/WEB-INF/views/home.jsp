...
-->
    ...
    <form:form modelAttribute="pgrq" method="get" action="sccSearch">
        ...
        <form:hidden path="searchType" items="${searchTypeCodeValueList}" itemValue="value" itemLabel="label"
                     value="tc"/>
...
<table class="tb1">
    ...
    <tr>
        <td>
            <button id="pay" onclick="window.open('http://www.longtermcare.or.kr/npbs/e/b/504/openPopEquipPaymtCalcu')">
                시설급여계산
            </button>
        </td>
    </tr>
...
<table class="tb2">
    ...
    <tr>
        <td>
            <button id="check"
                    onclick="window.open('http://www.longtermcare.or.kr/npbs/e/b/201/npeb201t02.web?menuId=npe0000000080')">
                장기요양등급
            </button>
        </td>
    </tr>
